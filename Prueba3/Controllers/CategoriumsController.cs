...
namespace Prueba3.Controllers
{
    ...
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(TumaeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'TumaeContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Categorium categorium)
        {
            if (id != categorium.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TumaeContext.Categoria'  is null.");
            }
            var categorium = await _context.Categoria.FindAsync(id);
            if (categorium != null)
            {
