...
namespace Prueba3.Controllers
{
    public class DetalleVentasController : Controller
    {
        ...
        public DetalleVentasController(TumaeContext context)
        {
            _context = context;
        }
        ...
        {
            var tumaeContext = _context.DetalleVentas.Include(d => d.IdproductoNavigation).Include(d => d.IdventaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IddetalleVenta,Idventa,Idproducto,PrecioUnitario,Cantidad")] DetalleVenta detalleVenta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IddetalleVenta,Idventa,Idproducto,PrecioUnitario,Cantidad")] DetalleVenta detalleVenta)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TumaeContext.DetalleVentas'  is null.");
            }
            var detalleVenta = await _context.DetalleVentas.FindAsync(id);
            if (detalleVenta != null)
            {
