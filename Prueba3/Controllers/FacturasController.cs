...
namespace Prueba3.Controllers
{
    public class FacturasController : Controller
    {
        ...
        public FacturasController(TumaeContext context)
        {
            _context = context;
        }
        ...
        {
            var tumaeContext = _context.Facturas.Include(f => f.IdventaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdFactura,Idventa,Total,TotalPago,FechaHora,Tipo")] Factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFactura,Idventa,Total,TotalPago,FechaHora,Tipo")] Factura factura)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TumaeContext.Facturas'  is null.");
            }
            var factura = await _context.Facturas.FindAsync(id);
            if (factura != null)
            {
