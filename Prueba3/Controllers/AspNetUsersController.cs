...
namespace Prueba3.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        public AspNetUsersController(TumaeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.AspNetUsers != null ?
                        ...
                        Problem("Entity set 'TumaeContext.AspNetUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'TumaeContext.AspNetUsers'  is null.");
            }
            var aspNetUser = await _context.AspNetUsers.FindAsync(id);
            if (aspNetUser != null)
            {
